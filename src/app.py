...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice skills and compete in interscholastic soccer matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Learn basketball fundamentals and play friendly games",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, learn stagecraft, and perform theatrical productions",
